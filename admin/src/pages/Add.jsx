...
const Add = ({token}) => {
  ...
  return (
    <form onSubmit={onhandleSubmit} className='flex flex-col w-full items-start gap-3' action="">
      <div>
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} value={price}  className='w-full max-w-[500px] sm:w-[120px] px-3 py-2' type="number" placeholder='Type here' required/>
        </div>
      </div>
      <div>
