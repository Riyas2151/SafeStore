...
const Collection = () => {
  ...
  const sortProducts =() =>{
    ...
    switch(sortType){
      case 'low-high':
        setFilterProducts(fpCopy.sort((a,b)=>(a._price - b._price)));
        break;
      case 'high-low':
        setFilterProducts(fpCopy.sort((a,b)=>(b._price - a._price)));
        break;
      ...
      <div className="min-w-60">
        ...
        <div className={`border border-gray-300 pl-5 py-3 my-5 
          ...
          font-light text-gray-700">
            ...
            <p className='flex gap-2'>
              <input className='w-3' type="checkbox" value={'Winterwears'} onChange={toggleSubCategory} />Winterwears
            </p>
          </div>
        </div>
      </div>
